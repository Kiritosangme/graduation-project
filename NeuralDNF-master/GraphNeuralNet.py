...
class GGNN: # Gated Graph Neural Network
    def __init__(self, embeddingDim = 128, nbIterations = 32, learningRate = 10**-5, gradientClip = 0.5, KLDirection = False,
        ...
        self.negLitProbs = 1.4 - self.posLitProbs  # Compute negative lit weights
        ...
        self.nbConjunctions = tf.placeholder(tf.int32, shape=[], name='nbConjuncts') #what meaning?
        ...
        # For training:
        self.ConjunctLitAdjacencyMatrix = tf.sparse_placeholder(tf.float32, shape=[None, None], name='ConjLitAdjMat')  # [Conjuncts,Literals] 邻接矩阵
        self.DisjunctConjunctAdjacencyMatrix = tf.sparse_placeholder(tf.float32, shape=[None, None], name='DisjConjAdjMat') #[Disjuncts, Conjuncts] 邻接矩阵
